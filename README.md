# MCP Workshop – Build a Movie Database MCP using .NET
...
- Clone the repo
- Run ` dotnet build .\src\movie-mcp\`
- Optionally, you can install and use `npx @modelcontextprotocol/inspector dotnet run --project ./src/movie-mcp/movie-mcp.csproj`
